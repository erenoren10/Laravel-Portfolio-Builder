...
<head>
    ...
    <link href="{{ asset('build/assets/css/generated.css') }}" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('assets/css/inter.css') }}">
    <link rel="apple-touch-icon" sizes="57x57" href="{{ asset('build/assets/img/fav/apple-icon-57x57.png') }}">
    <link rel="apple-touch-icon" sizes="60x60" href="{{ asset('build/assets/img/fav/apple-icon-60x60.png') }}">
    <link rel="apple-touch-icon" sizes="72x72" href="{{ asset('build/assets/img/fav/apple-icon-72x72.png') }}">
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('build/assets/img/fav/apple-icon-76x76.png') }}">
    <link rel="apple-touch-icon" sizes="114x114" href="{{ asset('build/assets/img/fav/apple-icon-114x114.png') }}">
    <link rel="apple-touch-icon" sizes="120x120" href="{{ asset('build/assets/img/fav/apple-icon-120x120.png') }}">
    <link rel="apple-touch-icon" sizes="144x144" href="{{ asset('build/assets/img/fav/apple-icon-144x144.png') }}">
    <link rel="apple-touch-icon" sizes="152x152" href="{{ asset('build/assets/img/fav/apple-icon-152x152.png') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('build/assets/img/fav/apple-icon-180x180.png') }}">
    <link rel="icon" type="image/png" sizes="192x192"
        href="{{ asset('build/assets/img/fav/android-icon-192x192.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('build/assets/img/fav/favicon-32x32.png') }}">
    <link rel="icon" type="image/png" sizes="96x96" href="{{ asset('build/assets/img/fav/favicon-96x96.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('build/assets/img/fav/favicon-16x16.png') }}">
    <link rel="stylesheet" href="{{ asset('build/assets/css/custom.css') }}">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="/ms-icon-144x144.png">
    <meta name="theme-color" content="#ffffff">
    <script src="{{ asset('build/assets/gh/alpinejs/alpine@v2.x.x/dist/alpine.min.js') }}" defer="" type="46f65d9080e5f580b2929d15-text/javascript"></script>
   ...
   ym(68644717, "init", {
    ...
    <noscript>
        <div><img src="watch/68644717/1.gif" style="position:absolute; left:-9999px;" alt=""></div>
    </noscript>
    <!-- /Yandex.Metrika counter -->
    <script type="46f65d9080e5f580b2929d15-text/javascript">
...
-->
    <div class="min-h-screen">
        ...
        <div class="relative bg-gray-800 overflow-hidden">
            ...
            <div class="relative pt-6 pb-16 sm:pb-24" x-data="Components.popover({ open: false, focus: true })" x-init="init()"
                ...
                <nav class="relative max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6"
                    ...
                    <div class="flex items-center flex-1">
                        <div class="flex items-center justify-between w-full md:w-auto">
                            <a href="#">
                                ...
                                <img class="h-8 w-auto sm:h-10" src="{{ asset('build/assets/img/start/logo.png') }}"
                                    alt="">
                            </a>
                        ...
                        <div class="hidden space-x-10 md:flex md:ml-10">
                            ...
                            <a href="#testimonials"
                                class="font-medium text-white hover:text-gray-300">Testimonials</a>
                    ...
                    <div class="hidden md:flex">
                        <a href="{{ route('login') }}"
                            class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700">Login/Register</a>
                    </div>
                </nav>
                ...
                <div x-show="open" x-transition:enter="duration-150 ease-out"
                    ...
                    <div class="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                        <div class="px-5 pt-4 flex items-center justify-between">
                            <div>
                                <img class="h-8 w-auto"
                                    src="{{ asset('build/assets/img/logos/workflow-mark-indigo-600.svg') }}"
                                    alt="">
                            </div>
                            <div class="-mr-2">
                                <button type="button"
                        ...
                        <a href="{{ route('login') }}"
                            class="block w-full px-5 py-3 text-center font-medium text-indigo-600 bg-gray-50 hover:bg-gray-100">Login/Register</a>
                    </div>
                </div>
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <p class="mt-3 text-base text-gray-300 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                                        85% of all people search on the Internet for services, restaurants, and much
                                        more.</p>
                                    <p class="mt-3 text-base text-gray-300 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl ">
                                        With a website from edan.io you will receive <b>more customer inquiries</b>!</p>
                                    <p class="mt-3 text-base text-gray-300 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                                        Your website in 5 minutes!</p>
                                    <div class="mt-10 sm:mt-12">
                                        <form action="/gui/site/account/choose.php" method="get"
                                            ...
                                            <div class="sm:flex">
                                                ...
                                                <div class="mt-3 sm:mt-0 sm:ml-3">
                                                    <button type="submit"
                                                        class="block w-full py-3 px-4 rounded-md shadow bg-indigo-500 text-white font-medium hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-300 focus:ring-offset-gray-900">Register
                                                        for free</button>
                                                </div>
                                            </div>
                                            <p class="mt-3 text-sm text-gray-300 sm:mt-4">✓ no costs ✓ no obligations ✓
                                                no stress</p>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div class="mt-16 sm:mt-24 lg:mt-0 lg:col-span-6 lg:flex">
                                <div class="sm:max-w-md sm:w-full sm:mx-auto sm:rounded-lg sm:overflow-hidden lg:flex">
                                    <div class="px-4 py-8 sm:px-10 lg:flex">
                                        <img class="w-auto lg:inset-y-0 lg:left-0 lg:flex lg:w-auto"
                                            src="{{ asset('build/assets/img/start/hero3.png') }}" alt="">
        ...
        <div class="py-12 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="lg:text-center" id="features">
                    ...
                    <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">What we
                        offer you</p>
                    <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">With edan.io you create a web presence
                        that is adapted to your and especially your customers' needs.</p>
                </div>
                ...
                <div class="mt-10">
                    <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                        <div class="relative">
                            ...
                            <dd class="mt-2 ml-16 text-base text-gray-500">Reach your customers in their preferred
                                ways. Integrate buttons for email, Whatsapp, Google maps, and more.</dd>
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <dd class="mt-2 ml-16 text-base text-gray-500">Our modules fit your industry. For example,
                                adding a menu to your restaurant is a breeze.</dd>
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <dd class="mt-2 ml-16 text-base text-gray-500">Manage the displayed reviews of your
                                customers. It's YOUR website! You decide what is displayed!</dd>
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <dd class="mt-2 ml-16 text-base text-gray-500">Our support staff can be reached quickly and
                                personally.</dd>
                        </div>
                    </dl>
                </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 text-center">
            <h2 class="text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl" id="examples">Need some
                inspiration?</h2>
            <p class="mt-3 max-w-2xl mx-auto text-xl text-gray-500 sm:mt-4">These pages were created with edan.io and
                bring their creators new customers.</p>
            <a href=""><img class="h-104 w-full object-cover"
                    src="{{ asset('build/assets/img/start/examples.jpg') }}" loading="lazy" alt=""></a>
        </div>
        ...
        <div class="bg-white pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
            <div class="relative max-w-lg mx-auto divide-y-2 divide-gray-200 lg:max-w-7xl">
                <div>
                    <h2 class="text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl text-center"
                        id="testimonials">What our customers say</h2>
                ...
                <div class="mt-12 grid gap-16 pt-12 lg:grid-cols-3 lg:gap-x-5 lg:gap-y-12">
                    <div>
                        <a href="#" class="block mt-4">
                            ...
                            <p class="mt-3 text-base text-gray-500">Thanks to our new web presence, noticeably more
                                customers have contacted us.</p>
                        </a>
                            ...
                            <div class="flex-shrink-0">
                                <a href="#">
                                    ...
                                    <img class="h-20 w-20 rounded-full"
                                        src="{{ asset('build/assets/img/start/mike.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="ml-3">
                    ...
                    <div>
                        ...
                        <a href="#" class="block mt-4">
                            <p class="text-xl font-semibold text-gray-900">Give (potential) customers a quick overview
                            </p>
                            <p class="mt-3 text-base text-gray-500">Now I can process requests faster by linking to my
                                new website.</p>
                        </a>
                        <div class="mt-6 flex items-center">
                            <div class="flex-shrink-0">
                                <a href="#">
                                    ...
                                    <img class="h-20 w-20 rounded-full"
                                        src="{{ asset('build/assets/img/start/steph.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="ml-3">
                    ...
                    <div>
                        <a href="#" class="block mt-4">
                            ...
                            <p class="mt-3 text-base text-gray-500">We can now be reached faster by customers and
                                receive more reservations.</p>
                        </a>
                        <div class="mt-6 flex items-center">
                            <div class="flex-shrink-0">
                                <a href="#">
                                    ...
                                    <img class="h-20 w-20 rounded-full"
                                        src="{{ asset('build/assets/img/start/martha.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="ml-3">
        ...
        <div class="bg-gray-50">
            <div class="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
                <div class="max-w-3xl mx-auto divide-y-2 divide-gray-200">
                    <h2 class="text-center text-3xl font-extrabold text-gray-900 sm:text-4xl" id="faq">
                            ...
                            <dt class="text-lg">
                                <button type="button" x-description="Expand/collapse question button"
                                    ...
                                    <span class="ml-6 h-7 flex items-center">
                                        <svg class="h-6 w-6 transform -rotate-180"
...
Heroicon name: outline/chevron-down"
                            ...
                            <dd class="mt-2 pr-12" id="faq-0" x-show="open">
                                <p class="text-base text-gray-500">Nothing. You can create a basic page for free.
                                    Premium features can be added later</p>
                            </dd>
                        </div>
...
Heroicon name: outline/chevron-down"
                            ...
                            <dd class="mt-2 pr-12" id="faq-1" x-show="open" style="display: none;">
                                <p class="text-base text-gray-500">If you have a business, you should have a web
                                    presence. Many people nowadays use the Internet to find services.</p>
                            </dd>
                        </div>
                        ...
                        <div x-data="{ open: false }" class="pt-6">
                            <dt class="text-lg">
                                <button type="button" x-description="Expand/collapse question button"
                                    ...
                                    x-bind:aria-expanded="open.toString()">
                                    <span class="font-medium text-gray-900">I have no idea about creating a website.
...
Heroicon name: outline/chevron-down"
                            ...
                            <dd class="mt-2 pr-12" id="faq-2" x-show="open" style="display: none;">
                                <p class="text-base text-gray-500">You do not need any previous experience. Our service
                                    is for everyone. Even to people who have no previous experience with the Internet or
...
Heroicon name: outline/chevron-down"
                            ...
                            <dd class="mt-2 pr-12" id="faq-3" x-show="open" style="display: none;">
                                <p class="text-base text-gray-500">Yes! You can use your domain and redirect to your
                                    web presence with us.</p>
                            </dd>
                        </div>
                        ...
                        <div x-data="{ open: false }" class="pt-6">
                            <dt class="text-lg">
                                <button type="button" x-description="Expand/collapse question button"
                                    ...
                                    aria-controls="faq-3" @click="open = !open" aria-expanded="false"
                                    x-bind:aria-expanded="open.toString()">
                                    <span class="font-medium text-gray-900">I would like to have my own domain. But I
                                        have no idea how to do that. Can you help?</span>
                                    <span class="ml-6 h-7 flex items-center">
                                        <svg class="rotate-0 h-6 w-6 transform"
                                            x-description="Expand/collapse icon, toggle classes based on question open state.
...
Heroicon name: outline/chevron-down"
                            ...
                            <dd class="mt-2 pr-12" id="faq-3" x-show="open" style="display: none;">
                                <p class="text-base text-gray-500"><a href='burgers-on-broadway.html'>Burger</a> <a
                                        href='bundt-park-dog-park.html'>Park</a> <a href='cafe-35.html'>Cafe</a></p>
                            </dd>
                        </div>
        ...
        <footer class="bg-grey-800">
            <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
                <nav class="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
                    <div class="px-5 py-2">
                        <a href="/contact-more" class="text-base text-gray-500 hover:text-gray-900 hidden"
                            rel="nofollow">Contact</a>
                        <a href="https://edan.io/contact"
                            class="text-base text-gray-500 hover:text-gray-900">Contact</a>
                    </div>
                    ...
                    <div class="px-5 py-2">
                        <a href="terms.html" class="text-base text-gray-500 hover:text-gray-900">Terms and
                            conditions</a>
                    </div>
    ...
    <script src="cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="46f65d9080e5f580b2929d15-|49" defer=""></script>
</body>
